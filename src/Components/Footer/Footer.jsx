...
export default function Footer() {
  return (
    <>
      {/* ========== FOOTER ========== */}
      <footer className="mt-auto bg-sky-800 w-full dark:bg-sky-800">
                ...
                <div className="mt-4 flex flex-col items-center gap-2 sm:flex-row sm:gap-3 bg-white rounded-lg p-2 dark:bg-neutral-900">
                  <div className="w-full">
                    ...
                    <input
                      ...
                      id="hero-input"
                      name="hero-input"
                      className="py-3 px-4 block w-full border-transparent rounded-lg text-sm outline-2 outline-sky-600"
